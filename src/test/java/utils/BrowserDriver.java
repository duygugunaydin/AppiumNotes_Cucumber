...
public class BrowserDriver {
    ...
    public static AndroidDriver getBrowserDriver()  {
        ...
        if (browserDriver == null) {
            ...
            caps.setCapability(MobileCapabilityType.DEVICE_NAME, "DUYGU");
            caps.setCapability(MobileCapabilityType.PLATFORM_VERSION, "10.0");
            caps.setCapability(MobileCapabilityType.PLATFORM_NAME, "Android");
            caps.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator2");
            caps.setCapability(MobileCapabilityType.NO_RESET,false);
            //caps.setCapability("chromedriverExecutable","C:\Users\Uporabnik\IdeaProjects\team108_Appium_Cucumber\Driver\chromedriver.exe");
